import svgPaths from "./svg-bqnj0lvji2";
...
function Frame() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute backdrop-blur-[2px] bg-[#f9f9f9] content-stretch flex gap-[12px] h-[69.577px] items-center justify-center left-[calc(50%+498.5px)] p-[10px] rounded-[999px] top-[calc(50%-0.21px)] w-[224px]">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#005400] text-[20px] text-center whitespace-nowrap">Let’s start</p>
      <StreamlineNext />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[158.722px] leading-[normal] left-[calc(50%-607.5px)] text-[58px] text-white top-[calc(50%-78px)] tracking-[-1.16px] w-[666px]">Are you ready to partner with us ?</p>
      <Frame />
    </div>
  );
}
