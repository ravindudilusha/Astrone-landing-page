...
// Product categories for Animal Health
const categories = [
  { name: "All Products", count: 12, isSpecial: true },
  { name: "Cattle", count: 3 },
  { name: "Poultry", count: 3 },
  { name: "Injectables for all animals", count: 3 },
  { name: "Pet", count: 3 },
];

// Sample Animal Health products
const allProducts = [
  { 
    id: 1, 
    ...
    description: "Nutritional supplement for cattle"
  },
  { 
    id: 2, 
    name: "Cattle Vitamins", 
    image: imgImage140, 
    category: "Cattle",
    categoryColor: "#8b4513",
    description: "Essential vitamins for livestock"
  },
  { 
    id: 3, 
    name: "Cattle Growth", 
    ...
    category: "Cattle",
    categoryColor: "#8b4513",
    description: "Growth enhancement formula"
  },
  { 
    id: 4, 
    name: "Poultry Feed", 
    ...
    description: "Complete poultry nutrition"
  },
  { 
    id: 5, 
    name: "Chicken Vitamins", 
    image: imgImage146, 
    category: "Poultry",
    categoryColor: "#d97706",
    description: "Vitamin supplement for poultry"
  },
  { 
    id: 6, 
    name: "Poultry Boost", 
  ...
  { 
    ...
    name: "Injectable A", 
    image: imgImage137, 
    category: "Injectables for all animals",
    categoryColor: "#0066cc",
    description: "Veterinary injectable"
  },
  { 
    id: 8, 
    name: "Injectable B", 
    ...
    category: "Injectables for all animals",
    categoryColor: "#0066cc",
    description: "Animal health solution"
  },
  { 
    id: 9, 
    name: "Injectable C", 
    ...
    category: "Injectables for all animals",
    categoryColor: "#0066cc",
    description: "Multi-purpose injectable"
  },
  { 
    id: 10, 
    name: "Pet Care Plus", 
    ...
    description: "Complete pet nutrition"
  },
  { 
    id: 11, 
    name: "Pet Vitamins", 
    ...
    category: "Pet",
    categoryColor: "#16a085",
    description: "Daily pet supplements"
  },
  { 
    id: 12, 
    name: "Pet Health", 
    ...
    <div className="min-h-screen bg-white">
      ...
      <ScrollAnimation delay={0.1} direction="up" className="text-center mt-12 sm:mt-[75px] mb-12 sm:mb-[95px] px-5 sm:px-6">
        ...
        <p className="font-['Plus_Jakarta_Sans',sans-serif] font-medium text-[16px] lg:text-[20px] leading-relaxed lg:leading-[37px] tracking-tight lg:tracking-[-0.4px] text-[#505050] max-w-[980px] mx-auto">
          The natural share of Astron business is currently in the local development, manufacture and marketing of several major animal health therapeutic groups in a variety of dosage forms, strengths and pack sizes. All these products are marketed under the Astron logo.
        </p>
      </ScrollAnimation>
                  ...
                  >
                    ...
                    <div className="absolute top-[14px] left-[11px] z-10">
                      <div 
                        ...
                        style={{ 
                          backgroundColor: product.categoryColor === "#8b4513" ? "#fff5e6" : product.categoryColor === "#d97706" ? "#fff5e6" : product.categoryColor === "#0066cc" ? "#ebf8ff" : "#e8f5f5"
                        }}
                      >
                        <p 
