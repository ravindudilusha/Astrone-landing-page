...
// Product categories for Nutrition
const categories = [
  { name: "All Products", count: 12, isSpecial: true },
  { name: "Nutrition for lifestyles", count: 6 },
  { name: "Nutrition for patient care", count: 6 },
];
...
const allProducts = [
  { 
    id: 1, 
    name: "Multi-Vita Plus", 
    image: imgImage145, 
    category: "Nutrition for lifestyles",
  ...
  { 
    ...
    category: "Nutrition for lifestyles",
    categoryColor: "#2f872d",
    description: "High-protein meal replacement"
  },
  { 
    id: 3, 
  ...
  { 
    ...
    category: "Nutrition for lifestyles",
    categoryColor: "#2f872d",
    description: "Bone health formula"
  },
  { 
    id: 6, 
    name: "Iron Complex", 
  ...
  { 
    id: 7, 
    name: "Patient Care Formula", 
    image: imgImage137, 
    category: "Nutrition for patient care",
  ...
  { 
    ...
    category: "Nutrition for patient care",
    categoryColor: "#aa5b00",
    description: "Post-surgery nutrition"
  },
  { 
    id: 9, 
    name: "Immune Support", 
  ...
  { 
    ...
    category: "Nutrition for patient care",
    categoryColor: "#aa5b00",
    description: "Age-specific nutrition"
  },
];
        ...
        <ScrollAnimation delay={0.2} direction="up" className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 lg:gap-10 mb-10 lg:mb-[50px]">
          <div className="flex flex-col gap-1">
            ...
            <p className="font-['Plus_Jakarta_Sans',sans-serif] font-normal text-[14px] lg:text-[16px] text-[#797979]">
              Scientific nutrition for a better life
            </p>
          </div>
