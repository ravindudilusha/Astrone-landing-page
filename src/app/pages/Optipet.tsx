...
import imgOptipetHero from "../../assets/5af76cf49ab89b1885a139c7c7d4af6593ed11d7.png";
...
// Product categories for Optipet
const categories = [
  { name: "All Products", count: 6, isSpecial: true },
  { name: "OPTIPET Herbaplus", count: 3 },
  { name: "OPTIPET", count: 3 },
];

// Sample Optipet products
const allProducts = [
  { 
    id: 1, 
    name: "Herbaplus Joint Care", 
    image: imgImage145, 
    category: "OPTIPET Herbaplus",
    categoryColor: "#2f872d",
    description: "Herbal joint support for pets"
  },
  { 
    id: 2, 
    name: "Herbaplus Immunity", 
    image: imgImage140, 
    category: "OPTIPET Herbaplus",
    categoryColor: "#2f872d",
  ...
  { 
    id: 3, 
    name: "Herbaplus Digest", 
    image: imgImage144, 
    category: "OPTIPET Herbaplus",
    categoryColor: "#2f872d",
    description: "Digestive health formula"
  },
  { 
    id: 4, 
    name: "Optipet Multivitamin", 
    image: imgImage143, 
    category: "OPTIPET",
    categoryColor: "#c97435",
    description: "Complete pet vitamins"
  },
  { 
    id: 5, 
    name: "Optipet Calcium", 
    image: imgImage146, 
    category: "OPTIPET",
    categoryColor: "#c97435",
  ...
  { 
    id: 6, 
    name: "Optipet Omega-3", 
    image: imgImage142, 
    category: "OPTIPET",
    categoryColor: "#c97435",
    description: "Skin & coat health"
  },
];
                  ...
                  >
                    ...
                    <div className="absolute top-[14px] left-[11px] z-10">
                      <div 
                        ...
                        style={{ 
                          backgroundColor: product.categoryColor === "#2f872d" ? "#e8f5e8" : "#fff5e6"
                        }}
                      >
                        <p 
