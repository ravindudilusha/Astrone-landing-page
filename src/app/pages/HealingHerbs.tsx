...
// Product categories for Healing Herbs
const categories = [
  { name: "All Products", count: 12, isSpecial: true },
  { name: "Immune Boosters", count: 4 },
  { name: "Cough & Cold", count: 4 },
  { name: "Liver Health", count: 4 },
];

// Sample Healing Herbs products
const allProducts = [
  { 
    id: 1, 
  ...
  { 
    ...
    category: "Immune Boosters",
    categoryColor: "#6b4423",
    description: "Herbal immune enhancer"
  },
  { 
    id: 3, 
  ...
  { 
    ...
    category: "Immune Boosters",
    categoryColor: "#6b4423",
    description: "Stress relief & immunity"
  },
  { 
    id: 5, 
    name: "Herbal Cough Relief", 
    image: imgImage146, 
    category: "Cough & Cold",
    categoryColor: "#2a5a2a",
    description: "Natural cough remedy"
  },
  { 
    id: 6, 
    name: "Ginger & Honey", 
    ...
    category: "Cough & Cold",
    categoryColor: "#2a5a2a",
    description: "Soothing throat formula"
  },
  { 
    id: 7, 
    name: "Eucalyptus Syrup", 
    image: imgImage137, 
    category: "Cough & Cold",
    categoryColor: "#2a5a2a",
  ...
  { 
    ...
    category: "Cough & Cold",
    categoryColor: "#2a5a2a",
    description: "Holy basil for wellness"
  },
  { 
    id: 9, 
    name: "Liver Detox", 
    ...
    description: "Herbal liver cleanser"
  },
  { 
    id: 10, 
    name: "Milk Thistle Plus", 
    image: imgImage145, 
    category: "Liver Health",
    categoryColor: "#8b4513",
  ...
  { 
    ...
    category: "Liver Health",
    categoryColor: "#8b4513",
    description: "Liver function support"
  },
];
        ...
        <ScrollAnimation delay={0.2} direction="up" className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 lg:gap-10 mb-10 lg:mb-[50px]">
          <div className="flex flex-col gap-1">
            ...
            <p className="font-['Plus_Jakarta_Sans',sans-serif] font-normal text-[14px] lg:text-[16px] text-[#797979]">
              Traditional herbal remedies for modern wellbeing
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className="absolute top-[14px] left-[11px] z-10">
                      <div 
                        ...
                        style={{ 
                          backgroundColor: product.categoryColor === "#6b4423" ? "#fff5e6" : product.categoryColor === "#2a5a2a" ? "#e8f5e8" : "#fff5e6"
                        }}
                      >
                        <p 
