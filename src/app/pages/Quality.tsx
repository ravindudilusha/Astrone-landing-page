...
export default function Quality() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white py-16 px-4 lg:px-5">
        <div className="max-w-[1400px] mx-auto">
          <p className="text-[#838383] font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[20px] mb-3 tracking-[-0.4px] text-center">
            Certifications
          </p>
          <h3 className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[48px] text-[#444] text-center mb-6 tracking-[-0.96px] leading-[normal]">
            Certified Quality and<br />Regulatory Compliance
          </h3>
          <p className="font-['Plus_Jakarta_Sans',sans-serif] text-[16px] leading-[30px] text-[#7c7c7c] opacity-80 tracking-[-0.16px] text-center max-w-[900px] mx-auto mb-16">
      ...
      {/* Partner CTA Section */}
      <section className="px-5 sm:px-6 pb-10 sm:pb-16 mt-12 sm:mt-16">
        <div className="max-w-[1400px] mx-auto">
